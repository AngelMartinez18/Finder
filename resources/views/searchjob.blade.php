...
<body class="bg-gray-200">
    ...
    <div class="container mx-auto px-4 py-4 sm:px-6 lg:px-8">
        <h1 class="p-2 text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-gray-900 leading-tight">
        ...
        <section id="search-bar" class="mt-6 flex flex-col md:flex-row gap-4 items-center justify-center bg-white p-6 rounded-lg shadow-md">
            ...
            <div id="input-location-div">
                ...
                <input id="input-location" name="input-location" type="text" placeholder="Ej: España Madrid" class="w-full p-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
        </section>
    ...
    function fetchJobs() {
        ...
        fetch(`searchjob?input-search=${q}&input-location=${location}`, {
    ...
    locationInput.addEventListener('input', fetchJobs);
</script>
</body>
</html>